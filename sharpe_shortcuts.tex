...
% sample sharpe ratio
\providecommand{\ssrUL}[2]{\mathUL{\hat{\psi}}{#1}{#2}}
...
\providecommand{\susr}[1][]{\MATHIT{\tilde{\psi}_{#1}}}
...
\providecommand{\psrUL}[2]{\mathUL{\psi}{#1}{#2}}
...
\providecommand{\E}[1]{\funcit{\mbox{\large E}}{#1}}
